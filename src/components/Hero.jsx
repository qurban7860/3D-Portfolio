...
const Hero = () => {
  return (
    <section className="relative w-full min-h-screen mx-auto overflow-hidden bg-primary isolate">
      <div className="absolute inset-0 bg-hero-pattern bg-cover bg-no-repeat bg-center opacity-90" />
      <div className="absolute inset-0 bg-gradient-to-b from-primary/95 via-primary/80 to-transparent z-10" />
      ...
      <div className="absolute bottom-0 left-0 right-0 top-1/4 z-20 w-full h-3/4">
        <ComputersCanvas />
      </div>
    </section>
  );
