...
import { BackToTop, Navbar, Footer, Certifications } from "../components";
  ...
  return (
    <div className="relative z-0 bg-transparent w-full min-h-screen overflow-x-hidden">
      ...
      <div className="pt-32 pb-10 px-6 max-w-7xl mx-auto text-center relative">
        <div className="absolute top-16 left-1/2 -translate-x-1/2 w-80 h-32 bg-[#00cea8]/10 blur-[80px] rounded-full pointer-events-none" />
        <motion.div
