  ...
  return (
    <div className="relative z-0 bg-primary w-full min-h-screen overflow-x-hidden">
      ...
      <div className="pt-32 pb-10 px-6 max-w-7xl mx-auto text-center relative">
        <div className="absolute top-16 left-1/2 -translate-x-1/2 w-80 h-32 bg-[#56ccf2]/10 blur-[80px] rounded-full pointer-events-none" />
        <motion.div
        ...
        >
          ...
          <h1 className={`${styles.sectionHeadText} mt-1`}>Skills &amp; Services</h1>
          <div className="w-16 h-[4px] rounded-full bg-white/10 relative overflow-hidden">
             <div className="absolute inset-0 bg-[#56ccf2] animate-shimmer" style={{ backgroundSize: '200% auto' }} />
          </div>
        </motion.div>
      </div>
