const styles = {
  ...
  ctaButton:
    "inline-flex items-center justify-center gap-2 px-8 py-4 text-[14px] backdrop-blur-[var(--glass-blur)] bg-[var(--primary)]/20 border border-[var(--primary)]/50 text-[var(--text-primary)] font-bold rounded-2xl hover:bg-[var(--primary)]/30 hover:border-[var(--primary)] hover:shadow-[0_0_32px_rgba(0,0,0,0.2)] hover:scale-105 active:scale-95 transition-all duration-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.3)]",

  /* ── Glassmorphism Cards ───────────────────────────────────── */
  glassCard:
    "backdrop-blur-[var(--glass-blur)] bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-[2rem] hover:border-[var(--primary)]/40 hover:shadow-[0_20px_50px_rgba(0,0,0,0.5)] transition-all duration-700",
  ...
  glassCardPurple:
    "backdrop-blur-[var(--glass-blur)] bg-[var(--primary)]/5 border border-[var(--primary)]/20 rounded-[2rem] hover:border-[var(--primary)]/50 hover:shadow-[0_20px_50px_rgba(0,0,0,0.5)] hover:bg-[var(--primary)]/10 transition-all duration-700",
  ...
  glassInput:
    "w-full rounded-2xl bg-white/5 border border-white/10 px-6 py-4 text-[var(--text-primary)] outline-none transition-all duration-500 focus:border-[var(--primary)] focus:bg-white/[0.12] focus:shadow-[0_0_25px_rgba(255,255,255,0.05),inset_0_1px_2px_rgba(0,0,0,0.3)] hover:border-white/20 hover:bg-white/[0.08] text-[15px] font-medium placeholder:text-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]",
};
