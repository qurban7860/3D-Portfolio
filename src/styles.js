const styles = {
  ...
  heroHeadText:
    "font-black text-white lg:text-[64px] sm:text-[48px] xs:text-[38px] text-[30px] lg:leading-[76px] tracking-tight",
  heroSubText:
    "text-[#dfd9ff] font-medium lg:text-[24px] sm:text-[20px] xs:text-[16px] text-[13px] lg:leading-[32px]",
